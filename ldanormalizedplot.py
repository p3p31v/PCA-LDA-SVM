...
color_samples = ['#0000FF', '#0000FF', '#0000FF', '#0000FF', '#0000FF', '#0000FF', '#0000FF', '#FFA500', '#FFA500', '#FFA500','#FFA500','#FFA500','#FFA500','#FFA500','#FFA500','#FA8072','#FA8072','#FA8072','#FA8072','#FA8072','#FA8072','#FA8072','#FA8072','#DAF7A6','#DAF7A6','#DAF7A6','#DAF7A6','#DAF7A6','#DAF7A6','#DAF7A6','#DAF7A6'] 
...
for label in range(0,30):
    pc0_pc1.append({
        ...
        'type': 'scatter',
        'mode': 'markers',
        'marker': {'color': color_samples[label], 'size': 10}
        })
